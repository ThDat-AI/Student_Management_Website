    ...
    const subMenuItems = [
        {
            ...
            color: "primary",
            path: "/giaovu/danh-sach-lop/lap-danh-sach"
        },
        {
            ...
            icon: <FaFileExcel />,
            color: "success",
            path: "/giaovu/danh-sach-lop/xuat-danh-sach"
        }
    ];
            ...
            <Container fluid className="px-4 py-4">
                ...
                <div className="welcome-banner p-4 rounded-4 position-relative overflow-hidden mb-4">
                    ...
                    <div className="welcome-content d-flex align-items-center">
                        ...
                        <div>
                            <h2 className="text-white mb-1 fw-bold banner-title">Quản lý Danh sách lớp</h2>
                            <p className="text-white-75 mb-0 banner-subtitle">Chọn chức năng để quản lý danh sách học sinh</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h5 className="fw-bold text-dark mb-3 border-start border-primary border-4 ps-2">Chọn chức năng</h5>
                    <Row className="g-4">
